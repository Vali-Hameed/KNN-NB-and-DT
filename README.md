...
The project uses the **Glass Identification Database** (sourced from the UCI Machine Learning Repository).

The dataset contains attributes of various glass samples and aims to classify them into different types based on their chemical composition.
